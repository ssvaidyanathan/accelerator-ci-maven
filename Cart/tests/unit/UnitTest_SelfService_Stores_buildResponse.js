...
//var js = require('../../CoreAPI/Proxies/SelfService_Stores/resources/jsc/js_buildResponse.js');
var js = require('../../apiproxy/resources/jsc/js_buildResponse.js');
...
describe('feature: rebuilding storeLocator API Response ', function() {
  ...
  it('AC1: API response rebuilding ', function(done) {
    var finalResp = js.createFinalResponse(resp1);
