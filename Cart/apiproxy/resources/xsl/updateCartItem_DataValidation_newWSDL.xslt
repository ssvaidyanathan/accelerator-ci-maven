...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/"
            xmlns:car="http://services.tmobile.com/SalesManagement/CartWSIL/V1"
            xmlns:base="http://service.tmobile.com/base">
            <soapenv:Header/>
            <soapenv:Body>
                <base:updateCartRequest serviceTransactionId="" version="">
                    <base:header>
                        <base:sender>
                  	...
                  	<xsl:element name="car:cart">
                        ...
                        <car:salesperson>BOON</car:salesperson>
                      	<xsl:element name="car:cartItem">
                          	<xsl:attribute name="cartItemId"><xsl:value-of select="$cartItemId"/></xsl:attribute>
