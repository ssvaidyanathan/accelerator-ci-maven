...
<xsl:stylesheet version="2.0"
	xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:v1="http://services.tmobile.com/OrderManagement/CartWSIL/V1"
	...
	<xsl:template match="v1:cart">
		<xsl:if test="normalize-space(.) != '' or @cartId or @actionCode">			
			<cart>
				...
				<xsl:apply-templates select="v1:totalTaxAmount" mode="cart"/>
				<xsl:apply-templates select="v1:extendedAmount" mode="cart" />
				<xsl:apply-templates select="v1:orderLocation" mode="cart"/>						
				<xsl:apply-templates select="v1:orderTime" mode="cart"/>				
				<xsl:apply-templates select="v1:status" mode="cart"/>
				<xsl:apply-templates select="v1:reason" mode="cart"/>
				<xsl:apply-templates select="v1:orderType" mode="cart"/>
				<xsl:apply-templates select="v1:salesChannel" mode="cart"/>
				<xsl:apply-templates select="v1:businessUnitName" mode="cart"/>				
				<xsl:apply-templates select="v1:salesperson" mode="cart"/>
				<xsl:apply-templates select="v1:cartSpecification"/>
				<xsl:apply-templates select="v1:backOrderAllowedIndicator"/>
				<xsl:apply-templates select="v1:ipAddress" mode="cart"/>				
				<xsl:apply-templates select="v1:deviceFingerPrintId" mode="cart"/>
				<xsl:apply-templates select="v1:termsAndConditionsDisposition" mode="cart"/>				
				<xsl:apply-templates select="v1:currentRecurringChargeAmount" mode="cart"/>
				<xsl:apply-templates select="v1:totalRecurringDueAmount" mode="cart"/>
				<xsl:apply-templates select="v1:totalDueAmount" mode="cart"/>
				...
				<xsl:apply-templates select="v1:shipping" mode="cart"/>
				<xsl:apply-templates select="v1:billTo" mode="cart"/>
				<xsl:apply-templates select="v1:cartItem" mode="cart"/>
				<xsl:apply-templates select="v1:charge" mode="cart"/>
				<xsl:apply-templates select="v1:deduction" mode="cart"/>				
				<xsl:apply-templates select="v1:tax" mode="cart"/>
				<xsl:apply-templates select="v1:freightCharge" mode="cart"/>
				<xsl:apply-templates select="v1:payment" mode="cart"/>
				<xsl:apply-templates select="v1:addressList" mode="cart"/>	
				<xsl:apply-templates select="v1:cartSummary" mode="cart"/>				
				<xsl:apply-templates select="v1:validationMessage" mode="cart"/>								
			</cart>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template match="v1:totalTaxAmount" mode="cart">
	...
	<xsl:template match="v1:extendedAmount" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>		
		<xsl:if test="(normalize-space(.) != '' or @currencyCode) and $check_IncludeExclude='1'">
	...
	<xsl:template match="v1:orderLocation" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
		...
		<xsl:if test="(normalize-space(.) != '' or @id) and $check_IncludeExclude='1'">
			<orderLocation>
				<xsl:if test="@id">
					...
					<xsl:if test="normalize-space(v1:location)!= ''">
							<location>
				...
				<!--xsl:apply-templates select="v1:dealerCode"/ -->
			</orderLocation>
		</xsl:if>
	</xsl:template>

	<xsl:template match="v1:orderTime" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
	...
	<xsl:template match="v1:status" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
	...
	<xsl:template match="v1:reason" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>		
		<xsl:if test="(normalize-space(.) != '') and $check_IncludeExclude='1'">
	...
	<xsl:template match="v1:orderType" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
	...
	<xsl:template match="v1:salesChannel" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
		<xsl:if test="(normalize-space(.) != '') and $check_IncludeExclude='1'">
	...
	<xsl:template match="v1:businessUnitName" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
	...
	<xsl:template match="v1:salesperson" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
		...
		<xsl:if test="(normalize-space(.) != '') and $check_IncludeExclude='1'">
			<salesperson>
			 <xsl:if test="v1:userName">
				...
				<xsl:apply-templates select="v1:personName" mode="cart_salesperson_personName"/>				
			</salesperson>
		</xsl:if>
	</xsl:template>
	
	
	<xsl:template match="v1:ipAddress" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>		
		<xsl:if test="(normalize-space(.) != '') and $check_IncludeExclude='1'">
	...
	<xsl:template match="v1:deviceFingerPrintId" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
	...
	<xsl:template match="v1:termsAndConditionsDisposition" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
		<xsl:if test="(normalize-space(.) != '') and $check_IncludeExclude='1'">
	...
	<xsl:template match="v1:currentRecurringChargeAmount" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
		<xsl:if test="(normalize-space(.) != '' or @currencyCode) and $check_IncludeExclude='1'">
	...
	<xsl:template match="v1:totalRecurringDueAmount" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
		<xsl:if test="(normalize-space(.) != '' or @currencyCode) and $check_IncludeExclude='1'">
	...
	<xsl:template match="v1:totalDueAmount" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
		<xsl:if test="(normalize-space(.) != '' or @currencyCode) and $check_IncludeExclude='1'">
	...
	<xsl:template match="v1:shipping" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
		<xsl:if test="(normalize-space(.) != '') and $check_IncludeExclude='1'">
	...
	<xsl:template match="v1:billTo" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
		<xsl:if test="(normalize-space(.) != '') and $check_IncludeExclude='1'">
	...
	<xsl:template match="v1:cartItem" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
		<xsl:if test="(normalize-space(.) != '' or @cartItemId or @actionCode) and $check_IncludeExclude='1'">
			<cartItem>
				...
				<xsl:apply-templates select="v1:cartItemStatus" mode="cartItem"/>				
				...
				<xsl:apply-templates select="v1:promotion" mode="cartitem"/>
				...
				<xsl:apply-templates select="v1:port" mode="cartItem"/>
			</cartItem>			
	...
	<xsl:template match="v1:charge" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
		<xsl:if test="(normalize-space(.) != '' or @actionCode) and $check_IncludeExclude='1'">
			<charge>				
				...
				<xsl:apply-templates select="v1:description" mode="cartItemStatus"/>
			</charge>			
		</xsl:if>
	</xsl:template>
	
	<xsl:template match="v1:deduction" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
		<xsl:if test="(normalize-space(.) != '' or @actionCode) and $check_IncludeExclude='1'">
	...
	<xsl:template match="v1:tax" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
		<xsl:if test="(normalize-space(.) != '') and $check_IncludeExclude='1'">
	...
	<xsl:template match="v1:freightCharge" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
		<xsl:if test="(normalize-space(.) != '') and $check_IncludeExclude='1'">
	...
	<xsl:template match="v1:payment" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
		<xsl:if test="(normalize-space(.) != '' or @actionCode) and $check_IncludeExclude='1'">
	...
	<xsl:template match="v1:payeeParty">
		<xsl:if test="normalize-space(.)!=''">
			<payeeParty>
				...
				<xsl:apply-templates select="v1:addressCommunication" mode="addressCommunication-payeeParty"/>
			</payeeParty>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template match="v1:addressList" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
		<xsl:if test="(normalize-space(.) != '') and $check_IncludeExclude='1'">
	...
	<xsl:template match="v1:cartSummary" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
		<xsl:if test="(normalize-space(.) != '') and $check_IncludeExclude='1'">
	...
	<xsl:template match="v1:deduction" mode="deduction-cartSummary">
		<xsl:if test="normalize-space(.) != ''">
			<deduction>
				...
				<xsl:apply-templates select="v1:promotion" mode="cartScheduleDeduction"/>
				<xsl:if test="normalize-space(v1:chargeCode)!=''">
					<chargeCode>
						<xsl:value-of select="v1:chargeCode"/>
					</chargeCode>
	...
	<xsl:template match="v1:validationMessage" mode="cart">
		<xsl:variable name="check_IncludeExclude">
			<xsl:call-template name="Include-Exclude"/>
		</xsl:variable>
		<xsl:if test="(normalize-space(.) != '') and $check_IncludeExclude='1'">
	...
	<xsl:template match="v1:extendedAmount|v1:totalChargeAmount|v1:totalDiscountAmount|
		v1:totalDueNowAmount|v1:totalDueMonthlyAmount|v1:requestAmount | v1:totalDuePayNowAmount" >
	...
	<xsl:template match="v1:backDateAllowedIndicator|v1:futureDateAllowedIndicator|
	v1:backDateVisibleIndicator|v1:futureDateVisibleIndicator|v1:unlimitedIndicator|
	v1:billableThirdPartyServiceIndicator|v1:prorateAllowedIndicator|v1:prorateVisibleIndicator|
	v1:feeOverrideAllowed">
	...
	<xsl:template match="v1:port" mode="cartItem">
	...
	<xsl:template match="v1:personProfile">
		<xsl:if test="normalize-space(.) != ''">
			<personProfile>
				<xsl:apply-templates select="v1:addressCommunication" mode="personProfile"/>
			</personProfile>		
		</xsl:if>
	</xsl:template>
	
	<xsl:template match="v1:addressCommunication" mode="personProfile">
		<xsl:if test="normalize-space(.) != ''">
			<addressCommunication>
	...
	<xsl:template match="v1:geoCodeID">
		<xsl:if test="normalize-space(.) != '' or @manualIndicator or @referenceLayer or @usageContext">
			<geoCodeID>
	...
	<xsl:template match="v1:geographicCoordinates">
		<xsl:if test="normalize-space(.) != ''">
			<geographicCoordinates>
				<xsl:if test="normalize-space(v1:latitude)!=''">
					<latitude>
						<xsl:value-of select="v1:latitude"/>
					</latitude>
				</xsl:if>
				
				<xsl:if test="normalize-space(v1:longitude)!=''">
					<longitude>
	...
	<xsl:template match="v1:lineOfService">
		<xsl:if test="normalize-space(.) != '' or @lineOfServiceId or @actionCode ">
			<lineOfService>				
				...
				<xsl:apply-templates select="v1:networkResource"/>
				<xsl:apply-templates select="v1:lineOfServiceStatus" mode="customerAccount"/>				
	...
	<xsl:template match="v1:assignedProduct">
		<xsl:if test="normalize-space(.) != '' or @actionCode">
			<assignedProduct>								
				...
				<xsl:apply-templates select="v1:key"/>
				<xsl:apply-templates select="v1:productOffering" mode="lineOfService-assignedProduct-productOffering"/>
				<xsl:apply-templates select="v1:effectivePeriod" mode="assignedProduct-effectivePeriod"/>
	...
	<xsl:template match="v1:assignedProduct" mode="cartItem-assignedProduct">
		<xsl:if test="normalize-space(.) != '' or @actionCode">
			<assignedProduct>								
				...
				<xsl:apply-templates select="v1:productOffering" mode="assignedProduct-productOffering"/>
			</assignedProduct>		
		</xsl:if>
	</xsl:template>
	
	<xsl:template match="v1:productOffering" mode="assignedProduct-productOffering">
		<xsl:if test="normalize-space(.) != '' or @productOfferingId">
			<productOffering>				
				...
				<xsl:apply-templates select="v1:shortDescription" mode="productOffering-description"/>
				<xsl:apply-templates select="v1:longDescription" mode="productOffering-description"/>
				<xsl:apply-templates select="v1:alternateDescription" mode="productOffering-description"/>
				<xsl:apply-templates select="v1:keyword" mode="productOffering"/>							
				...
				<xsl:apply-templates select="v1:offeringClassification" mode="productOffering"/>								
				...
				<xsl:apply-templates select="v1:key"/>					
				<xsl:apply-templates select="v1:specificationGroup"/>
				<xsl:apply-templates select="v1:offeringPrice" mode="assignedProduct-productOffering-offeringPrice"/>
				...
				<xsl:apply-templates select="v1:offeringVariant" mode="productOffering"/>
				<xsl:apply-templates select="v1:productOfferingComponent"/>
				<xsl:apply-templates select="v1:productSpecification" mode="assignedProduct-productOffering"/>
			</productOffering>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template match="v1:subscriberContact">
		<xsl:if test="normalize-space(.) != ''">
			<subscriberContact>			
				<xsl:apply-templates select="v1:addressCommunication" mode="subscriberContact"/>
			</subscriberContact>
		</xsl:if>
	</xsl:template>
	
	<xsl:template match="v1:addressCommunication" mode="subscriberContact">
		<xsl:if test="normalize-space(.) != '' or @actionCode or @id">
			<addressCommunication>
				...
				<xsl:apply-templates select="v1:address" mode="subscriberContact-addressCommunication"/>
				<xsl:if test="normalize-space(v1:usageContext)!=''">
					<usageContext>
						<xsl:value-of select="v1:usageContext"/>
					</usageContext>
	...
	<xsl:template match="v1:address" mode="subscriberContact-addressCommunication">
		<xsl:if test="normalize-space(.) != ''">
			<address>
				<xsl:apply-templates select="v1:key" mode="subscriberContact-addressCommunication" />
			</address>		
		</xsl:if>
	</xsl:template>
	
	<xsl:template match="v1:key" mode="subscriberContact-addressCommunication">
		<xsl:if test="normalize-space(.) != ''">
			<key>					
	...
	<xsl:template match="v1:cartItemStatus|v1:cartScheduleStatus">
	...
	<xsl:template match="v1:cartScheduleCharge">
		<xsl:if test="normalize-space(.) != '' or @actionCode">
			<cartScheduleCharge>				
				...
				<xsl:if test="normalize-space(v1:description)!=''">					
					<description>
						<xsl:if test="v1:description/@usageContext">
							<xsl:attribute name="usageContext">
								<xsl:value-of select="v1:description/@usageContext"/>
							</xsl:attribute>
						</xsl:if>
						<xsl:value-of select="v1:description"/>
					</description>
	...
	<xsl:template match="v1:description" mode="cartScheduleCharge">
		<xsl:if test="normalize-space(.) != ''">
			<description>
				<xsl:value-of select="."/>
			</description>			
	...
	<xsl:template match="v1:relatedOrder">
		<xsl:if test="normalize-space(.)!=''">
			<relatedOrder>
			   <xsl:if test="v1:orderId">
				<orderId>
					<xsl:value-of select="v1:orderId"/>
				</orderId>
			   </xsl:if>	
			   <xsl:if test="v1:relationshipType">
				<relationshipType>
	...
	<xsl:template match="v1:overrideThresholdPercent">
		<xsl:if test="normalize-space(.) != ''">
	...
	<xsl:template match="v1:overrideThresholdAmount">
		<xsl:if test="normalize-space(.) != '' or @currencyCode">
			<overrideThresholdAmount>	
				<xsl:attribute name="currencyCode">
					<xsl:value-of select="if (@currencyCode != '')
						then  @currencyCode else 'USD'"/>
				</xsl:attribute>	
	...
	<xsl:template match="v1:overrideAmount">
		<xsl:if test="normalize-space(.) != '' or @currencyCode">
			<overrideAmount>	
				<xsl:attribute name="currencyCode">
					<xsl:value-of select="if (@currencyCode != '')
	...
	<xsl:template match="v1:description" mode="cartScheduleDeduction">
		<xsl:if test="normalize-space(.) != ''">
			<description>
				<xsl:value-of select="."/>
			</description>		
	...
	<xsl:template match="v1:promotion" mode="cartitem">	
	...
	<xsl:template match="v1:promotion" mode="cartScheduleDeduction">
		<xsl:if test="normalize-space(.) != '' or @promotionId">
			<promotion>
				<xsl:if test="@promotionId">
					<xsl:attribute name="promotionId">
	...
	<xsl:template match="v1:productOffering">
		<xsl:if test="normalize-space(.) != '' or @productOfferingId">
			<productOffering>				
				...
				<xsl:apply-templates select="v1:key"/>					
				<xsl:apply-templates select="v1:specificationGroup"/>
				<xsl:apply-templates select="v1:offeringPrice" mode="productOffering"/>
				<xsl:apply-templates select="v1:orderBehavior" mode="productOffering"/>
				<xsl:apply-templates select="v1:image"/>
				<xsl:apply-templates select="v1:marketingMessage"/>
				<xsl:apply-templates select="v1:equipmentCharacteristics"/>
				<xsl:apply-templates select="v1:serviceCharacteristics"/>				
	...
	<xsl:template match="v1:productOffering" mode="lineOfService-assignedProduct-productOffering">
		<xsl:if test="normalize-space(.) != '' or @productOfferingId">
			<productOffering>				
				<xsl:if test="@productOfferingId">
					<xsl:attribute name="productOfferingId">
	...
	<xsl:template match="v1:productSpecification" mode="assignedProduct-productOffering">
		<xsl:if test="normalize-space(.) != '' or @actionCode or @productSpecificationId">
			<productSpecification>				
				<xsl:if test="@actionCode">
					<xsl:attribute name="actionCode">
	...
	<xsl:template match="v1:offeringVariant" mode="productOffering">
		<xsl:if test="normalize-space(.)!=''">
			<offeringVariant>				
				...
				<xsl:apply-templates select="v1:specificationGroup"/>
				<xsl:apply-templates select="v1:offeringVariantPrice" mode="offeringVariant"/>
	...
	<xsl:template match="v1:offeringVariantPrice" mode="offeringVariant">
	...
	<xsl:template match="v1:orderBehavior" mode="productOffering">
		<xsl:if test="normalize-space(.) != ''">
			<orderBehavior>
	...
	<xsl:template match="v1:offeringPrice" mode="productOffering">
		<xsl:if test="normalize-space(.) != '' or @priceListLineId">
			<offeringPrice>				
				<xsl:if test="@priceListLineId">
					<xsl:attribute name="priceListLineId">
				...
				<xsl:apply-templates select="v1:productOfferingPrice" mode="productOffering"/>
			</offeringPrice>		
			
		</xsl:if>
	</xsl:template>
	
	<xsl:template match="v1:offeringPrice" mode="assignedProduct-productOffering-offeringPrice">
		<xsl:if test="normalize-space(.) != '' or @priceListLineId">
			<offeringPrice>				
				<xsl:if test="@priceListLineId">
					<xsl:attribute name="priceListLineId">
				...
				<xsl:apply-templates select="v1:productOfferingPrice" mode="assignedProduct-productOffering"/>
			</offeringPrice>			
			
		</xsl:if>
	</xsl:template>
	
	<xsl:template match="v1:productOfferingPrice" mode="productOffering">
		<xsl:if test="normalize-space(.) != ''">
	...
	<xsl:template match="v1:productOfferingPrice" mode="assignedProduct-productOffering">
		<xsl:if test="normalize-space(.) != ''">
			<productOfferingPrice>
				<xsl:if test="normalize-space(v1:name)!=''">
					<name>
	...
	<xsl:template match="v1:productType | v1:productSubType" mode="productOffering">
		<xsl:if test="normalize-space(.) != ''">
			<xsl:element name="{local-name()}">
				<xsl:value-of select="."/>
			</xsl:element>			
	...
	<xsl:template match="v1:offeringClassification" mode="productOffering">
		<xsl:if test="normalize-space(.) !=''">
	...
	<xsl:template match="v1:keyword" mode="productOffering">
		<xsl:if test="normalize-space(.) != '' or @name">
			<keyword>
				<xsl:if test="@name">
					<xsl:attribute name="name">
	...
	<xsl:template match="v1:longDescription | v1:alternateDescription" mode="productOffering-description">
		<xsl:if test="normalize-space(.) != ''">
			<xsl:element name="{local-name()}">
	...
	<xsl:template match="v1:description|v1:shortDescription" mode="productOffering-description">
		<xsl:if test="normalize-space(.) != '' or @languageCode or @usageContext or @salesChannelCode">
			<xsl:element name="{local-name()}">
				<xsl:if test="@languageCode">
					<xsl:attribute name="languageCode">
						<xsl:value-of select="@languageCode"/>
	...
	<xsl:template match="v1:cartItemStatus" mode="cartItem">
		<xsl:if test="normalize-space(.)!='' or @statusCode !=''">
			<cartItemStatus>
				<xsl:if test="@statusCode !=''">
					<xsl:attribute name="statusCode">
	...
	<xsl:template match="v1:description" mode="cartItemStatus">
		<xsl:if test="normalize-space(.) != ''">
			<description>				
				<xsl:value-of select="." />
			</description>
	...
	<xsl:template match="v1:customer">
		<xsl:if test="normalize-space(.) != '' or @actionCode or @customerId">
			<customer>
				...
				<xsl:apply-templates select="v1:status" mode="customer"/>
	...
	<xsl:template match="v1:party">
		<xsl:if test="normalize-space(.) != ''">
			<party>
				...
				<xsl:apply-templates select="v1:person" mode="party"/>
			</party>
		</xsl:if>
	</xsl:template>
	
	<xsl:template match="v1:person" mode="party">
		<xsl:if test="normalize-space(.)!=''">
			<person>
				...
				<xsl:apply-templates select="v1:addressCommunication" mode="party-person"/>
			    <xsl:if test="v1:birthDate">
				     <birthDate>
					    <xsl:value-of select="v1:birthDate"/>
				    </birthDate>
			   </xsl:if>
				<xsl:apply-templates select="v1:phoneCommunication" mode="party-person"/>
				<xsl:apply-templates select="v1:emailCommunication" mode="party-person"/>
				...
				<xsl:apply-templates select="v1:securityProfile" mode="party-securityProfile"/>
        ...
        <xsl:if test="normalize-space(.) != ''">
            <nationalIdentityDocument>
                ...
                <xsl:if test="normalize-space(v1:primaryIndicator) != ''">
                    <primaryIndicator>
                        <xsl:value-of select="v1:primaryIndicator"/>
                    </primaryIndicator>
                </xsl:if>
                <xsl:if test="normalize-space(v1:taxIDIndicator) != ''">
                    <taxIDIndicator>
                        <xsl:value-of select="v1:taxIDIndicator"/>
                    </taxIDIndicator>
                </xsl:if>
	...
	<xsl:template match="v1:securityProfile" mode="party-securityProfile">
		<xsl:if test="normalize-space(.) != ''">
			<securityProfile>    			
			<xsl:if test="v1:userName">
				<userName>
        ...
        <xsl:if test="normalize-space(.) != '' or @id">
            <driversLicense>
                ...
                <xsl:if test="normalize-space(v1:suspendedIndicator) != ''">
                    <suspendedIndicator>
                        <xsl:value-of select="v1:suspendedIndicator"/>
                    </suspendedIndicator>
                </xsl:if>
	...
	<xsl:template match="v1:emailCommunication" mode="party-person">
		<xsl:if test="normalize-space(.) != ''">
			<emailCommunication>
	...
	<xsl:template match="v1:phoneCommunication" mode="party-person">
		<xsl:if test="normalize-space(.) != ''">
			<phoneCommunication>
	...
	<xsl:template match="v1:addressCommunication" mode="party-person">
		<xsl:if test="normalize-space(.) != '' or @actionCode or @id">
			<addressCommunication>					
				<xsl:if test="@actionCode">
					<xsl:attribute name="actionCode">
	...
	<xsl:template match="v1:status" mode="customer">
		<xsl:if test="normalize-space(.) != '' or @statusCode">
			<status>
	...
	<xsl:template match="v1:customerAccount">
		<xsl:if test="normalize-space(.) != ''">
			<customerAccount>
				...
				<xsl:apply-templates select="v1:programMembership" mode="customerAccount"/>
				<xsl:apply-templates select="v1:paymentProfile" mode="customerAccount"/>
				<xsl:apply-templates select="v1:preferredLanguage"/>				
				...
				<xsl:apply-templates select="v1:financialAccount" mode="customerAccount"/>
			</customerAccount>
		</xsl:if>
	</xsl:template>
	
	<xsl:template match="v1:financialAccount" mode="customerAccount">
		<xsl:if test="normalize-space(.)!='' or @actionCode">
			<financialAccount>
				<xsl:if test="@actionCode">
					<xsl:attribute name="actionCode">
				...
				<xsl:apply-templates select="v1:status" mode="customerAccount"/>
	...
	<xsl:template match="v1:status | v1:lineOfServiceStatus" mode="customerAccount">
		<xsl:if test="normalize-space(.) != '' or @statusCode">
			<xsl:element name="{local-name()}">
	...
	<xsl:template match="v1:billingContact">
		<xsl:if test="normalize-space(.)!=''">
			<billingContact>
				<xsl:apply-templates select="v1:addressCommunication" mode="addressCommunication-billingContact"/>
			</billingContact>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template match="v1:addressCommunication" mode="addressCommunication-billingContact">
		<xsl:if test="normalize-space(.) != '' or @actionCode or @id">
			<addressCommunication>					
				...
				<xsl:apply-templates select="v1:address" mode="address-addressCommunication-billingContact"/>
				<xsl:apply-templates select="v1:usageContext"/>
			</addressCommunication>
		</xsl:if>
	</xsl:template>

	<xsl:template match="v1:address" mode="address-addressCommunication-billingContact">
		<xsl:if test="normalize-space(.) != ''">
			<address>
				<xsl:apply-templates select="v1:key"/>
			</address>		
	...
	<xsl:template match="v1:accountContact">
		<xsl:if test="normalize-space(.)!=''">
			<accountContact>
				<xsl:apply-templates select="v1:addressCommunication" mode="accountContact-addressCommunication"/>
			</accountContact>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template match="v1:addressCommunication" mode="accountContact-addressCommunication">
		<xsl:if test="normalize-space(.) != '' or @actionCode or @id">
			<addressCommunication>
				...
				<xsl:apply-templates select="v1:privacyProfile" mode="privacyProfile-addressCommunication"/>
				<xsl:apply-templates select="v1:address" mode="address-addressCommunication-billingContact"/>
				<xsl:apply-templates select="v1:usageContext"/>
			</addressCommunication>
		</xsl:if>
	...
	<xsl:template match="v1:privacyProfile" mode="privacyProfile-addressCommunication">
		<xsl:if test="normalize-space(.) != ''">
			<privacyProfile>
	...
	<xsl:template match="v1:paymentProfile" mode="customerAccount">
		<xsl:if test="normalize-space(.)!=''">
			<paymentProfile>
	...
	<xsl:template match="v1:programMembership" mode="customerAccount">
		<xsl:if test="normalize-space(.) != ''">
			<programMembership>
	...
	<xsl:template match="v1:shipTo">
		<xsl:if test="normalize-space(.) != ''">
			<shipTo>
				...
				<xsl:apply-templates select="v1:phoneCommunication" mode="shipTo"/>
				<xsl:apply-templates select="v1:emailCommunication" mode="shipTo"/>
				<xsl:apply-templates select="v1:preferredLanguage"/>
				<xsl:apply-templates select="v1:note"/>
	...
	<xsl:template match="v1:preferred">
		<xsl:if test="normalize-space(.) != ''">
			<preferred>
				<xsl:value-of select="."/>				
			</preferred>		
	...
	<xsl:template match="v1:phoneCommunication" mode="shipTo">
		<xsl:if test="normalize-space(.) != ''">
			<phoneCommunication>
	...
	<xsl:template match="v1:emailCommunication" mode="shipTo">
		<xsl:if test="normalize-space(.) != ''">
			<emailCommunication>
	...
	<xsl:template match="v1:location" mode="cart_location">
		<xsl:if test="normalize-space(.) != '' or @id">
			<location>
				<xsl:if test="@id">
					<xsl:attribute name="id">
	...
	<xsl:template match="v1:personName" mode="cart_salesperson_personName">
		<xsl:if test="normalize-space(.) != ''">
		  <personName>				
			 <xsl:if test="v1:firstName">
				<firstName>
	...
	<xsl:template match="v1:totalDueAmount|v1:totalRecurringDueAmount|v1:amount|v1:totalFeeAmount|v1:totalTaxAmount|
		v1:totalSoftGoodRecurringDueNowAmount|v1:totalSoftGoodOneTimeDueNowAmount|v1:totalHardGoodDueNowAmount|
		v1:totalSoftGoodDueNowAmount|v1:totalExtendedAmount|v1:totalDeltaRecurringDueAmount|
		v1:totalCurrentRecurringAmount | v1:basisAmount | v1:totalRefundAmountDueLater | v1:totalRefundAmountDueNow | 
		v1:finalRefundAmountDueNow">
		<xsl:if test="normalize-space(.) != '' or @currencyCode">
			<xsl:element name="{local-name()}">				
				<xsl:attribute name="currencyCode">
					<xsl:value-of select="if (@currencyCode != '')
