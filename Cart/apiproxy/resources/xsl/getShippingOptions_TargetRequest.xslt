...
<xsl:stylesheet version="2.0" 
    ...
    <xsl:template match="/">
        <soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/">
            <soapenv:Header/>
            <soapenv:Body>
                <v1:getShippingOptionsRequest version="1">
                    ...
                    <v1:cartId><xsl:value-of select="$cartId"/></v1:cartId>
                    <v1:returnAvailabilityDate>
                    <xsl:choose>
                        <xsl:when
                            test="$include and $include = 'inventorystatus'">
