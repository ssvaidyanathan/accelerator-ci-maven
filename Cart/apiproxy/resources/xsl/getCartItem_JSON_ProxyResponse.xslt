...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template
        match="v1:key | v1:description | v1:simType | v1:specialInstruction | v1:shortDescription | v1:alternateDescription | v1:productType | v1:productSubType | v1:personName | v1:displayPurpose | v1:virtualSim |  v1:relatedCartItemId">
        <xsl:if test="normalize-space(.) !=''">
