...
-->
	...
	<xsl:template
		match="
			v1:key | v1:description
			| v1:shortDescription | v1:specificationValue | v1:promotionDescription | v1:promotionCode
	...
	<xsl:template match="v1:accountContact">
		<xsl:if test="normalize-space(.) != '' or count(.//@*) != 0">
			<accountContact>
				<xsl:apply-templates select="v1:addressCommunication" mode="addressCommunication-accountContact"/>
			</accountContact>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template match="v1:person">
		<xsl:if test="normalize-space(.) != ''">
			<person>
				...
				<xsl:apply-templates select="v1:preferredLanguage"/>
				<xsl:apply-templates select="v1:addressCommunication" mode="addressCommunicationperson"/>
	...
	<xsl:template match="v1:addressCommunication" mode="addressCommunicationsubscriberContact">
		<xsl:if test="normalize-space(.) != '' or @id or @actionCode">
			<addressCommunication>
				...
				<xsl:apply-templates select="v1:address"/>
				<xsl:apply-templates select="v1:usageContext"
					mode="addressCommunication-usageContext"/>
			</addressCommunication>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template match="v1:resourceSpecification">
		<xsl:if test="normalize-space(.) != '' or @name">
			<resourceSpecification>
				...
				<xsl:if test="normalize-space(v1:specificationValue) != ''">
					<specificationValue>
						<xsl:value-of select="v1:specificationValue"/>
					</specificationValue>
				</xsl:if>
			</resourceSpecification>
		</xsl:if>
